  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Web系フリーランスkitsuneのブログの問い合わせページです。" />
      </Head>
      <div className="main">
        <h2 className="heading">{heading}</h2>
        <p>お仕事、その他のお問い合わせやご相談はこちらのフォームより承っております。</p>
        <form onSubmit={() => { setThanks('お問い合わせありがとうございます。メッセージは正常に送信されました。') }}
          target="submitComplete" action="https://docs.google.com/forms/u/0/d/e/1FAIpQLSf44oo_fDuu-s1fEjk9thwcuslzNmwtwgS0_YCJqblLmr-KIA/formResponse" method="post">
          <label>
            <span>お名前</span>
