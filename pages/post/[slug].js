    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content={blog.fields.description ? blog.fields.description : 'Web系フリーランスkitsuneのブログです。'} />
                <meta property="og:site_name" content="kitsune Blog" />
                <meta property="og:title" content={blog.fields.title + ' | kitsune Blog'} />
                <meta property="og:image" content={'https:' + blog.fields.thumbnail.fields.file.url} />
            ...
            <div className="main">
                ...
                <div className="sns-share">
                    <a className="twitter" onClick={twitterShare}>
                        <i className="fab fa-twitter"></i><span>ツイート</span>
                    </a>
                    <a className="facebook" onClick={facebookShare}>
                        <i className="fab fa-facebook-f"></i><span>シェア</span>
                    </a>
                ...
                <p className="thumbnail">
                    <img src={'https:' + blog.fields.thumbnail.fields.file.url} width='200' height='200' />
                </p>
