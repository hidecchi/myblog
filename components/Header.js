...
export default function Header() {
    ...
    return (
        <header>
            <h1 className="site-title"><Link href="/" >Kitsune Blog</Link></h1>
            <div className={drawerOpen ? 'menus is-open' : 'menus'}>
                <nav>
                    <ul>
                        <li><Link href="/"><a>ホーム</a></Link></li>
                        <li><Link href="/archive"><a>アーカイブ</a></Link></li>
                        <li><Link href="/profile"><a>プロフィール</a></Link></li>
            ...
            <div className={drawerOpen ? 'menu-btn is-open' : 'menu-btn'} onClick={toggleDrawer}>
                <span></span>
                <span></span>
            </div>
            <style jsx>{`
